...
print(db.select_addresses())
print(db.select_payments())
print(db.select_orders())
print(db.select_store_items())
print(db.select_shopping_carts())
print(db.select_shopping_cart_items())
print(db.select_address_by('address_line1'))
